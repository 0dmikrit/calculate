...
class MainWindow(Frame):
    ...
    def widgets(self):
        ...
        button_equally = Button(self, text='=', width=13, command=self.btn_equal)
        button_equally.grid(row=1, column=0, columnspan=3)

        button_equally = Button(self, text='CE', width=6, command=self.clear)
        button_equally.grid(row=1, column=3)
        ...
        b_div = Button(self, text='/', width=6, command=lambda: self.press('/'))
        ...
        b_pl = Button(self, text='+', width=6, command=lambda: self.press('+'))
